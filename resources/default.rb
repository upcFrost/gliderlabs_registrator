...
attribute :resync, Integer, default: node['gliderlabs_registrator']['run_opts']['resync']
attribute :retry_attempts, Integer, default: node['gliderlabs_registrator']['run_opts']['retry-attempts']
attribute :retry_interval, Integer, default: node['gliderlabs_registrator']['run_opts']['retry-interval']
attribute :tags, String, default: node['gliderlabs_registrator']['run_opts']['tags']
attribute :ttl, Integer, default: node['gliderlabs_registrator']['run_opts']['ttl']
attribute :ttl_refresh, Integer, default: node['gliderlabs_registrator']['run_opts']['ttl-refresh']
